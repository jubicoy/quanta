...
public class WorkerDefinitionColumnRecord extends UpdatableRecordImpl<WorkerDefinitionColumnRecord> implements Record9<Long, String, String, String, Boolean, String, Integer, String, Long> {
    ...
    @Override
    public Row9<Long, String, String, String, Boolean, String, Integer, String, Long> valuesRow() {
    ...
    @Override
    public WorkerDefinitionColumnRecord values(Long value1, String value2, String value3, String value4, Boolean value5, String value6, Integer value7, String value8, Long value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkerDefinitionColumnRecord(Long id, String name, String class_, String format, Boolean nullable, String columnType, Integer index, String description, Long definitionId) {
        super(WorkerDefinitionColumn.WORKER_DEFINITION_COLUMN);
