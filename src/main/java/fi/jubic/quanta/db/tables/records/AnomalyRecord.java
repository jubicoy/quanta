...
public class AnomalyRecord extends UpdatableRecordImpl<AnomalyRecord> implements Record8<Long, Long, LocalDateTime, LocalDateTime, JSONB, String, Double, JSONB> {
     ...
     */
    public void setSample(JSONB value) {
        set(4, value);
    }
    ...
    @Override
    public Row8<Long, Long, LocalDateTime, LocalDateTime, JSONB, String, Double, JSONB> valuesRow() {
    ...
    @Override
    public AnomalyRecord value5(JSONB value) {
        setSample(value);
        return this;
    }
    ...
    @Override
    public AnomalyRecord value8(JSONB value) {
        setMetadata(value);
        return this;
    }

    @Override
    public AnomalyRecord values(Long value1, Long value2, LocalDateTime value3, LocalDateTime value4, JSONB value5, String value6, Double value7, JSONB value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AnomalyRecord(Long id, Long invocationId, LocalDateTime startingTime, LocalDateTime endingTime, JSONB sample, String classification, Double probability, JSONB metadata) {
        super(Anomaly.ANOMALY);
