...
public class TaskRecord extends UpdatableRecordImpl<TaskRecord> implements Record9<Long, String, Long, String, Long, String, LocalDateTime, Long, Long> {
    ...
    /**
     * Setter for <code>task.sync_interval_offset</code>.
     */
    public void setSyncIntervalOffset(Long value) {
        set(8, value);
    }

    /**
     * Getter for <code>task.sync_interval_offset</code>.
     */
    public Long getSyncIntervalOffset() {
        return (Long) get(8);
    }
    ...
    @Override
    public Row9<Long, String, Long, String, Long, String, LocalDateTime, Long, Long> valuesRow() {
    ...
    public Field<Long> field9() {
        return Task.TASK.SYNC_INTERVAL_OFFSET;
    }
    ...
    @Override
    public TaskRecord value9(Long value) {
        setSyncIntervalOffset(value);
        return this;
    }

    @Override
    public TaskRecord values(Long value1, String value2, Long value3, String value4, Long value5, String value6, LocalDateTime value7, Long value8, Long value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TaskRecord(Long id, String name, Long workerDefId, String cronTrigger, Long taskTrigger, String taskType, LocalDateTime deletedAt, Long dataSeriesId, Long syncIntervalOffset) {
        super(Task.TASK);
        ...
        setSyncIntervalOffset(syncIntervalOffset);
    }
}
