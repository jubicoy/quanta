...
public class TaskRecord extends UpdatableRecordImpl<TaskRecord> implements Record7<Long, String, Long, String, Long, String, Timestamp> {
     ...
     */
    @Override
    public Row7<Long, String, Long, String, Long, String, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, String, Long, String, Long, String, Timestamp> valuesRow() {
     ...
     */
    @Override
    public TaskRecord values(Long value1, String value2, Long value3, String value4, Long value5, String value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TaskRecord(Long id, String name, Long workerDefId, String cronTrigger, Long taskTrigger, String taskType, Timestamp deletedAt) {
        super(Task.TASK);
