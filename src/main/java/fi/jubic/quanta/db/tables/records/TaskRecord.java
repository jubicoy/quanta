...
public class TaskRecord extends UpdatableRecordImpl<TaskRecord> implements Record8<Long, String, Long, String, Long, String, Long, Timestamp> {
     ...
     */
    @Override
    public Row8<Long, String, Long, String, Long, String, Long, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row8<Long, String, Long, String, Long, String, Long, Timestamp> valuesRow() {
     ...
     */
    @Override
    public TaskRecord values(Long value1, String value2, Long value3, String value4, Long value5, String value6, Long value7, Timestamp value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TaskRecord(Long id, String name, Long workerDefId, String cronTrigger, Long taskTrigger, String taskType, Long dataSeriesId, Timestamp deletedAt) {
        super(Task.TASK);
