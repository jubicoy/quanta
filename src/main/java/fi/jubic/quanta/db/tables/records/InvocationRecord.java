...
public class InvocationRecord extends UpdatableRecordImpl<InvocationRecord> implements Record9<Long, Long, String, Long, Long, String, Timestamp, Timestamp, Timestamp> {

    private static final long serialVersionUID = -1887143205;
     ...
     */
    @Override
    public Row9<Long, Long, String, Long, Long, String, Timestamp, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, Long, String, Long, Long, String, Timestamp, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public InvocationRecord values(Long value1, Long value2, String value3, Long value4, Long value5, String value6, Timestamp value7, Timestamp value8, Timestamp value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public InvocationRecord(Long id, Long invocationNumber, String status, Long taskId, Long workerId, String config, Timestamp startingTime, Timestamp endingTime, Timestamp deletedAt) {
        super(Invocation.INVOCATION);
