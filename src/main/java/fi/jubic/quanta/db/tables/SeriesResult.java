...
public class SeriesResult extends TableImpl<SeriesResultRecord> {
    ...
    private static final long serialVersionUID = 1145012532;
     ...
     */
    public final TableField<SeriesResultRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>series_result.invocation_id</code>.
     */
    public final TableField<SeriesResultRecord, Long> INVOCATION_ID = createField("invocation_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>series_result.table_name</code>.
     */
    public final TableField<SeriesResultRecord, String> TABLE_NAME = createField("table_name", org.jooq.impl.SQLDataType.VARCHAR(512).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SERIES_RESULT_PKEY);
    }
